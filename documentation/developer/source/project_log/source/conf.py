...
rst_epilog = """
.. |APE| replace:: *All-In-One Performance Evaluator*
.. |DUT| replace:: *Device Under Test*
.. |TPC| replace:: *Traffic PC*
.. |CPC| replace:: *Control PC*
.. |AP| replace::  *Access Point*
.. |TOT| replace:: *Throughput Over Time*
.. |ADB| replace:: *Android Debug Bridge*
.. |SSH| replace:: *Secure Shell*
.. |NAXXX| replace:: *Networked Power Switch*
.. |PMC| replace:: *Puppet Master PC*
"""
...
latex_documents = [
  ('index', 'apetools.tex', basename + u' Documentation',
   u'russelln', 'manual'),
]
...
epub_title = basename + u' Lab Report'
