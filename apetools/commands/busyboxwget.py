...
HEADER = 'Elapsed(seconds),Complete(%),Size(kbits),Error\n'
...
class BusyboxWget(BaseClass):
    ...
    def expression(self):
        ...
        if self._expression is None:
            ...
            # busybox seems to always use `k` as a unit so it is not included
...
class TestBusyboxWget(unittest.TestCase):
    ...
    def test_killed_server(self):
        ...
        self.assertEqual('14538', match.group(BusyboxEnum.kbits_transferred))
        return
    ...
    def test_run(self):
        ...
        self.assertEqual('65536', data.kbits)
    ...
    def test_error_string(self):
        ...
        self.assertEqual('34564', data.kbits)
