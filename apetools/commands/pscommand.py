...
PID = oatbran.NAMED(n=ProcessGrepEnum.pid,
                           e=oatbran.INTEGER)
TTY = oatbran.GROUP("\?" + oatbran.OR + "pts/" + oatbran.INTEGER +
...
#android ps
USER = oatbran.CLASS(oatbran.ALPHA_NUMS + '_') + oatbran.ONE_OR_MORE
PPID = oatbran.INTEGER
VSIZE = oatbran.INTEGER
RSS = oatbran.INTEGER
