THEMES = ["classic", "vim", "dark vim", "monkey"]
...
def get_palette(may_use_fancy_formats, theme="classic"):
    ...
    if theme == "classic":
        ...
        palette_dict.update({
            ...
            "breakpoing focused source": ("white", "dark magenta"),
            "current breakpoint focused source": (add_setting("white","bold"), "dark red"),
            ...
            "frame class": ("dark blue", "white"),
            "focused frame class": ("white", "dark blue"),
            "frame location": ("black", "white"),
            "focused frame location": ("white", "black"),
            
            "current frame name": ("black", "white"),
            "focused current frame name": ("white", "black"),
            "current frame location": ("dark blue", "white"),
            "focused current frame location": ("white", "dark blue"),

            #breakpoints
            "breakpoint": ("black", "white"),
            "current breakpoint": ("dark blue", "white"),
            "focused current breakpoint": ("white", "dark blue"),
            "focused breakpoint": ("white", "dark blue"),
            "focused current breakpoint": ("white", "black"),
            "selectable": ("black", "white"),
            "focused selectable": ("white", "black"),
                
            
            "source": ("black", "default"),
            "current source": (add_setting("white","bold"), "dark gray"),
            "focused source": (add_setting("white", "bold"), "dark magenta"),
            "current focused source": (add_setting("white","bold"), "dark blue"),
            "keyword": ("brown", "default"),
            "kw_namespace": ("dark magenta", "default"),
            "literal": ("black", "default"),
            "string": ("dark red", "default"),
